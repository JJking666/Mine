...
<template>
	<view class="login-bg">
		<view class="t-login">
			...
			<view class="t-e cl">
				<view class="t-g" @tap="wxLogin()"><image src="../../static/img/login/wx2.png"></image></view>
				<view class="t-g" @tap="zfbLogin()"><image src="../../static/img/login/qq2.png"></image></view>
				<view class="t-g" @tap="zfbLogin()"><image src="../../static/img/login/wb.png"></image></view>
			</view>
		</view>
